...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="<spring:url  value="resources/assets/js/ie8-responsive-file-warning.js"/>"></script><![endif]-->
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="${pageContext.request.contextPath}/bookList">Books</a></li>
